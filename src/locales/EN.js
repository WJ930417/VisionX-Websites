...
export default {
  ...
  transferSuccess:
    "Transaction successful, please wait and check for update on blocks",
  transferFail: "Transaction Failed",
  confirmTrTitle: "Confirm Transfer",
  confirmTrMsg:
    "You are sending <b>{amount}</b> DBC to this address:<br> <b>{address}</b>",
  ...
  gpu: {
    ...
    notice_1:
      "Please keep your private key safe, once a private key is lost, no one can retrieve your DBC asset for you!",
    amount: " Amount",
    ...
    idle_status: ["All Machines", "Idle Machines", "Rented Machines"], // new

    dbc_version: ["All", "V0.3.7.2"],
    have_ip: ["All", "NO", "YES"],
    ...
    bindMail: "Email", // new
    bindMailInfo:
      "This email address is used to receive the SSH account log in information for machine<br>" +
    ...
    receiveMailInfo:
      "Please click receive email and enter the DBC amount specified in the email to complete verification",
  ...
  msg: {
    dlg_0:
      "machine current longest available time {time},minimal rental time is one hour \n " +
    ...
    dlg_5:
      "If the machine stops abruptly during use and the usage time has not exceeded 144 hours, all DBC will be refunded. \n" +
      "<br>" +
      "If the usage time exceeds 144 hours then a total of DBC equal to 144 hours usage will be refunded.",
    wallet_0:
    ...
    wallet_5:
      "You must remember your password, do not lose it, " +
      "you need this password and your private key to unlock your wallet"
  },
  home: {
    intr_dbchain_1: "VisionX",
    ...
    intr_1:
      " provides GPU rental service.join us! can help your machine very convenient access to the DBC network, gain revenue. \n" +
      "\n" +
    ...
    intr_2:
      "Our GPUs come from all over the world, connected through the DBC distributed network, there is no centralized server in here, your data will not be stolen. \n",
    intr_3:
      " In the DBC network You need the DBC token to rent and use GPU(s).GPU(s) are priced in USD, the higher the price of DBC the less DBC you need in order to pay.",
    ...
    intr_5:
      "In the DBC network you can find cheap and varied GPUs. Throughout the usage of the GPU(s) your data are encrypted during transmission.",
    intr_6:
      "GPU rental is charged by the minute, if a GPU machine stops abruptly during usage you can be compensated up to 144 hour's rental fee.",
    intr_7:
      "DBC will start mining from 2020 and each year 500 million DBCs are mined, starting from the 4th year, 250 millions are mined each year and the amount is halved every 5 years from then on. A total of 4 billion DBCs will be mined.",
    intr_8:
      "Join DBC income combo: supernodes reward + mining reward + rental reward",
  ...
  help: {
    ...
    "5":
      "5.Transfer DBC to your account from other wallets that support DBC, such as neotracker.io, O3 Wallet",
  ...
  miner: {
    ...
    addMc_msg_2:
      "After installation you need to enter current wallet address in order to bind your machine on the platform.",

    addMc_msg_4: ["Each GPU's price "],
    addMc_msg_5: "",
    ...
    mc_msg_1:
      "if the machine stops during usage, then the DBC equal to 144 hours of sage staked will be deducted. <br>If the rental time is less than 144 hours, then all DBC will be deducted"
  },
  mcList: {},
  ...
  my_machine_order_vocing_pay:
    "Verifying payment, this will take a few minutes.",
  my_machine_order_pay_error: "verification for payment failed,over time",
  my_machine_order_return_dbc: "Refund successful",
  my_machine_order_vocing_machine_success:
    "Verification for machine environment successful",
  ...
  myMachine_rent_success_msg:
    "Machine has been rented successfully, log in details are sent to your email, please check your email and save the log in details.",
  myMachine_is_pay_vocing: "Paymet being verified",
  myMachine_maybe_is_used:
    "Machine might be rented by someone else already, please cancel order and rent another machine.",
  myMachine_is_vocing_machine:
    "Verifying whether machine environment is suitable, please wait, it will take a few minutes.",
  ...
  dlg_bindMail_no_dbc:
    "DBC balance not enough to bind email address, please deposit at least 1 DBC",
  ...
  dlg_try: "Trial",
  dlg_try_condition:
    "Conditions for a trial: current wallet holds more than 1,000 DBC in balance",
  ...
  dlg_try_msg:
    "Once payment is successful, machine log in details will be sent to your email address",

  drop_item_select: "Please select",
  drop_item_no_data: "No data",

  wallet_box_adddress:
    "Wallet address: your wallet address is also your account, when you give this address to another person, the other person can send DBC token to your address.",
  wallet_box_keystore:
    "Private key saved document: private key saved document exist in an encrypted password form to save your private key, we suggest you always use your private key to unlock your wallet.",
  wallet_box_key:
    "Your private key is the unencrypted version of your private key, this means no password is needed. If someone finds your unencrypted private key they can access your wallet without a password. So please always use your encrypted private key.",
  ...
  add_machine_msg_tips:
    "the platform charges 10% fee.\n" +
  ...
  my_machine_miner_tips:
    "If the machine stops during usage then the DBC for 7 days of usage staked in the contract will be deducted. If the rental was less than 7 days then all DBC is deducted.",
  ...
  open_wallet_cannot_read:
    "Your browser does not support reading of local document",

  footer_service: "Customer support",
  footr_reply: "customer service will reply within 24 hours",
  footer_service_dbchain: "support@visionx.org", //9.17 19:33
  ...
  pay_over_time:
    "Unable to pay. It has expired for 10 minutes. The order will be cancelled within 1 minute", //9.29 00:26
