    ...
    <div class="content wrap1440">
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item command="minerHome">{{
            $t("heads.miner")
          }}</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      ...
      <a
        ...
        >{{ set_dbctalk }}</a
      >
      <a class="item" v-else href="https://t.me/VisionXGlobal" target="_blank"
        >Join Telegram</a
      >
...
export default {
  ...
  methods: {
    ...
    set_ico() {
      ...
      this.link.href = "./visionx.ico";

      document.getElementsByTagName("head")[0].appendChild(this.link);
    },

    set_title() {
      document.title = "VisionX";
    },
    set_logo() {
      this.logo = require("../../assets/imgs/visionx_logo.png");
    },
    pushMenu(name) {
      this.menuName = name;
